...
export default function Home() {
  ...
  // In a real app we'd iterate over Object.keys(questionBank)
  const bookId = 'science10';
  const book = (questionBank as any)[bookId];
  
  const totalQuestions = book.chapters.reduce((acc: number, ch: any) => acc + ch.questions.length, 0);
